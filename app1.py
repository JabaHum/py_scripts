...
def subnet_calc():
	...
	try:
		...
		while True:
			...
			#masks = [255, 254, 252, 248, 240, 224, 192, 128, 0]#Checking Subnet Mask validity
	...
	#Convert mask to binary string
		...
		for octet_index in range(0, len(mask_octets_decimal)):
			...
			if len(binary_octet) == 8:
				...
				#print no_of_zeros
				#print no_of_ones
				#print no_of_hosts#Obtaining wildcard mask
		wildcard_octets = []
		...
		#print broadcast_address#Results for selected IP/mask
